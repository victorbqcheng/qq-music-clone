...
const LocalAndDownload = observer(() => {
    ...
    return (
        <div className='min-h-full flex flex-col'> {/* w-[calc(100vw-275px)] */}
            <h1 className='text-3xl font-bold'>本地和下载</h1>
            <div className='flex flex-row gap-4 mt-1 h-10 text-[16px] font-[350] bg-background sticky top-[0px] z-50'>
